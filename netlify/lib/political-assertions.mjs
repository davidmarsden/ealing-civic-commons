...
export const POLITICAL_ASSERTIONS = [
  ...
  assertion({ id: 'commons-assertion:gary-malcolm-leader-of-opposition-2026', from: person('gary-malcolm','Gary Malcolm'), to: council, type: 'leader_of_opposition_on', note: 'The council’s 2026/27 appointments record Gary Malcolm as Leader of the Opposition.', evidence: oppositionEvidence }),
  assertion({ id: 'commons-assertion:gary-malcolm-leader-of-ealing-libdem-group-2026', from: person('gary-malcolm','Gary Malcolm'), to: libDemGroup, type: 'leader_of', note: 'Gary Malcolm leads the Liberal Democrat opposition group on Ealing Council.', evidence: oppositionEvidence }),
  assertion({ id: 'commons-assertion:jon-ball-shadow-planning-2026', from: person('jon-ball','Jon Ball'), to: libDemGroup, type: 'shadow_cabinet_member_of', note: 'Jon Ball is the opposition spokesperson for Planning, Licensing and Regeneration and also serves as opposition whip.', evidence: oppositionEvidence }),
  assertion({ id: 'commons-assertion:jonathan-oxley-shadow-finance-2026', from: person('jonathan-oxley','Jonathan Oxley'), to: libDemGroup, type: 'shadow_cabinet_member_of', note: 'Jonathan Oxley is the opposition spokesperson for Finance.', evidence: oppositionEvidence }),
  assertion({ id: 'commons-assertion:mark-sanders-shadow-accountability-2026', from: person('mark-sanders','Mark Sanders'), to: libDemGroup, type: 'shadow_cabinet_member_of', note: 'Mark Sanders is the opposition spokesperson for Honesty and Accountability.', evidence: oppositionEvidence }),
  assertion({ id: 'commons-assertion:adam-keenan-shadow-childrens-services-2026', from: person('adam-keenan','Adam Keenan'), to: libDemGroup, type: 'shadow_cabinet_member_of', note: 'Adam Keenan is the opposition spokesperson for Children’s Services.', evidence: oppositionEvidence }),
  assertion({ id: 'commons-assertion:andrew-steed-shadow-adult-services-2026', from: person('andrew-steed','Andrew Steed'), to: libDemGroup, type: 'shadow_cabinet_member_of', note: 'Andrew Steed is the opposition spokesperson for Adult Services.', evidence: oppositionEvidence }),
  assertion({ id: 'commons-assertion:athena-zissimos-shadow-environment-crime-2026', from: person('athena-zissimos','Athena Zissimos'), to: libDemGroup, type: 'shadow_cabinet_member_of', note: 'Athena Zissimos is the opposition spokesperson for Environment and Crime.', evidence: oppositionEvidence }),
  assertion({ id: 'commons-assertion:connie-hersch-deputy-opposition-leader-2026', from: person('connie-hersch','Connie Hersch'), to: libDemGroup, type: 'deputy_leader_of', note: 'The Liberal Democrat group records Connie Hersch as Deputy Leader after the May 2026 election.', evidence: ['ealing-councillors-by-party-2026'] }),
  assertion({ id: 'commons-assertion:gary-busuttil-shadow-transport-2026', from: person('gary-busuttil','Gary Busuttil'), to: libDemGroup, type: 'shadow_cabinet_member_of', note: 'The Liberal Democrat group records Gary Busuttil as its Transport spokesperson after the May 2026 election.', evidence: ['ealing-councillors-by-party-2026'] })
];
