...
replaceOnce(
  ...
  '\t\t\treturn (true);\n' +
  '\t\tcase "/offline.html": // COMMONS CHAT OVERLAY: PWA\n' +
  '\t\t\tconst offlineHtml = "<!doctype html><html lang=\\\"en\\\"><head><meta charset=\\\"utf-8\\\"><meta name=\\\"viewport\\\" content=\\\"width=device-width,initial-scale=1\\\"><meta name=\\\"theme-color\\\" content=\\\"#0f4a37\\\"><title>Offline — Commons Chat</title><style>body{margin:0;min-height:100vh;display:grid;place-items:center;padding:24px;background:#f6f4ee;color:#17362b;font-family:system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif}main{max-width:560px;text-align:center}h1{font-family:Georgia,serif;font-size:2rem}p{font-size:1.05rem;line-height:1.6}a{display:inline-block;margin-top:12px;padding:12px 18px;border-radius:999px;background:#0f4a37;color:#fff;text-decoration:none;font-weight:700}</style></head><body><main><h1>Commons Chat is offline</h1><p>Conversations need a connection to load and post. Reconnect, then try again.</p><a href=\\\"/\\\">Try again</a></main></body></html>";\n' +
  '\t\t\ttheRequest.httpReturn (200, "text/html; charset=utf-8", offlineHtml, {"cache-control": "public, max-age=3600"});\n' +
  '\t\t\treturn (true);\n' +
  '\t\tcase "/sw.js": // COMMONS CHAT OVERLAY: PWA\n' +
  '\t\t\tconst sw = [\n' +
  '\t\t\t\t"const CACHE = \\\"commons-chat-pwa-v2\\\";",\n' +
